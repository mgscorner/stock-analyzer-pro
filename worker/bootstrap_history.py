...
def main() -> int:
    ...
    if args.missing_only:
        symbols = filter_missing_symbols(client, symbols, "history_status")
    if args.limit:
    ...
    if args.missing_only:
        print("missing_only: history_status")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--missing-only",
        action="store_true",
        help="Skip symbols where history_status is already complete.",
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
